<!-- Start Topbar Mobile -->
            <div class="topbar-mobile" style="background-color: #000000">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="mobile-logobar">
                            <a href="index.html" class="mobile-logo">{{--<img src="{{asset('assets/images/logo.png')}}" class="img-fluid" alt="logo">--}}<h3 class="text-white">Consultas</h3></a>
                        </div>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                                ...
                                                <div class="userbox">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="media dropdown-item">
                                                            <a href="{{ url('usuarios/'.Auth::user()->id.'/edit') }}" class="profile-icon"><img src="{{asset('assets/images/svg-icon/user.svg')}}" class="img-fluid" alt="user">Mi perfil</a>
                                                        </li>
