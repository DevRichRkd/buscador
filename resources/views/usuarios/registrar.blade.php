...
<div class="card">
    <div class="card-body">
        <h1>{{__('crear').' '.__('usuarioTitulo')}}</h1>
        <div class="row">  
            @if($perm['R'])            
                <div class="col-md-12">
                    <form class="forms-sample" action="{{ url('usuarios') }}" method="POST" role="form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" maxlength="50" class="form-control @error('name') is-invalid @else @if(old('name')) is-valid @endif @enderror" name="name" id="name" value="{{old('name')}}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" maxlength="50" class="form-control @error('email') is-invalid @else @if(old('email')) is-valid @endif @enderror" name="email" id="email" value="{{old('email')}}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" maxlength="50" class="form-control @error('password') is-invalid @else @if(old('password')) is-valid @endif @enderror" name="password" id="password">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" maxlength="50" class="form-control @error('password') is-invalid @else @if(old('password-confirm')) is-valid @endif @enderror" name="password_confirmation" id="password-confirm">
                                        ...
                                        @for($i=0; $i < count($data['rows']); $i++)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" >
                                                    <div class="switch">
                                                        <label>
                                                            <input type="checkbox" name="R[]" id="R{{ $data['rows'][$i]->id }}" value="{{ $data['rows'][$i]->id }}" class="input-sm validaCheck" idRecurso="{{ $data['rows'][$i]->id }}" {{ $readonly }}>
                                                            <span class="lever"></span>
                                                        </label>
                                                    </div>
                                                </td>
                                                <td class="text-center" >
                                                    <div class="switch">
                                                        <label>
                                                            <input type="checkbox" name="I[]" id="I{{ $data['rows'][$i]->id }}" value="{{ $data['rows'][$i]->id }}" class="input-sm"  {{ $readonly }}>
                                                            <span class="lever"></span>
                                                        </label>
                                                    </div>
                                                </td>
                                                <td class="text-center" >
                                                    <div class="switch">
                                                        <label>
                                                            <input type="checkbox" name="U[]" id="U{{$data['rows'][$i]->id }}" value="{{ $data['rows'][$i]->id }}" class="input-sm" {{ $readonly }}>
                                                            <span class="lever"></span>
                                                        </label>
                                                    </div>
                                                </td>
                                                <td class="text-center" >
                                                     <div class="switch">
                                                        <label>
                                                           <input type="checkbox" name="D[]" id="D{{ $data['rows'][$i]->id }}" value="{{ $data['rows'][$i]->id }}" class="input-sm"  {{ $readonly }}>
                                                            <span class="lever"></span>
                                                        </label>
                                                    </div>
                                                </td>
                                                <td class="text-center" >
                                                    <div class="switch">
                                                        <label>
                                                            <input type="checkbox" name="SF[]" id="SF{{ $data['rows'][$i]->id }}" value="{{ $data['rows'][$i]->id }}" class="input-sm"  {{ $readonly }}>
                                                            <span class="lever"></span>
                                                        </label>
                                                    </div>
                                                </td>
                                                <td class="text-center" >
                                                    <div class="switch">
                                                        <label>
                                                            <input type="checkbox" name="DF[]" id="DF{{ $data['rows'][$i]->id }}" value="{{ $data['rows'][$i]->id }}" class="input-sm" {{ $readonly }}>
                                                            <span class="lever"></span>
                                                        </label>
                                                    </div>
                                                </td>
