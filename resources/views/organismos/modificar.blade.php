...
<div class="card">
    <div class="card-body">
        <h1>{{__('editar').' '.__('Organismos garantes')}}</h1>
        <div class="row">  
            @if($perm['R'])            
                <div class="col-md-12">
                    <form class="forms-sample" action="{{ route('organismos.update', $organismos->id) }}" method="POST" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="entidad" id="entidad" class="form-control">
                                            ...
                                            @foreach($entidades as $entidad => $valor)
                                                @if($valor->id == $organismos->id_entidad)
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" maxlength="1500" class="form-control @error('nombre') is-invalid @else @if(old('nombre')) is-valid @endif @enderror" name="nombre" id="nombre" value="{{$organismos->nombre}}">
                        ...
                        <div class="row">
                            <div class="col-md-9 offset-3">
                                <div class="form-check form-check-flat form-check-primary">
                                    @php
                                        $check = null;
                                        $check = ($organismos->estatus == 1) ?  'checked="checked"': '' ;
                                    @endphp
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="float-right pr-3 ">
                                    <a href="{{ url('organismos') }}" class="btn bg-secondary lighten-1  z-depth-3 text-light">
                                        {{__('cancelar')}}
                                    </a>
                                </div>      
                                <div class="float-right pr-3">
