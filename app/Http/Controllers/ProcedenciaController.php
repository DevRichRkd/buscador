...
class ProcedenciaController extends Controller{
    ...
    public function __construct(){
        ...
        $this->cadenaBuscada = "procedencia";
    }
    ...
    public function index(){
        ...
        $procedencia =  DB::connection('mysql')->select("SELECT * FROM institucion_procedencia");
        return view('procedencia/listar')->with([
    ...
    public function create(){
        ...
        return view('procedencia/registrar')->with([
                                                'perm'     => $perm[0],
                                                ]);
    }
    ...
    public function store(Request $request){
        ...
        $this->validate($request, [
            'nombre'      => 'required|max:1500|unique:institucion_procedencia|max:200'
        ]);
        ...
        $procedencia->nombre      = $request['nombre'];
        $procedencia->estatus     = $estatus;

        if ($procedencia->save()) {
            return redirect('/procedencia')->with([
    ...
    public function edit($id){
        ...
        return view('procedencia/modificar')->with([
                                                    "procedencia" => $procedencia,
                                                    "perm"     => $perm[0]
                                                ]);
    }
    ...
    public function update(Request $request, $id){
        ...
        if ($request->nombre != $request->nombreOriginal) {
            $this->validate($request, [
                'nombre'      => 'required|max:1500|unique:institucion_procedencia'
            ]);
        }
    ...
    public function destroy($id){
        ...
        $existe = $this->existenDependientes('id_procedencia',$id);
        if (count($existe) >= 1) {
