...
class PertenenciaController extends Controller{
    ...
    public function __construct(){
        ...
        $this->cadenaBuscada = "pertenencia";
    }
    ...
    public function index(){
        ...
        $pertenencia =  DB::connection('mysql')->select("SELECT * FROM institucion_pertenencia");
        return view('pertenencia/listar')->with([
    ...
    public function create(){
        ...
        return view('pertenencia/registrar')->with([
                                                'perm'     => $perm[0],
                                                ]);
    }
    ...
    public function store(Request $request){
        ...
        $this->validate($request, [
            'nombre'      => 'required|unique:institucion_pertenencia|max:1500'
        ]);
        ...
        $pertenencia->nombre      = $request['nombre'];
        $pertenencia->estatus     = $estatus;

        if ($pertenencia->save()) {
            return redirect('/pertenencia')->with([
    ...
    public function edit($id){
        ...
        $pertenencia = Pertenencia::findOrFail($id);

        return view('pertenencia/modificar')->with([
                                                    "pertenencia" => $pertenencia,
                                                    "perm"     => $perm[0]
                                                ]);
    }
    ...
    public function update(Request $request, $id){
        ...
        if ($request->nombre != $request->nombreOriginal) {
            $this->validate($request, [
                'nombre'      => 'required|max:1500|unique:institucion_pertenencia'
            ]);
        }
    ...
    public function destroy($id){
        ...
        $existe = $this->existenDependientes('id_pertenencia',$id);
        if (count($existe) >= 1) {
